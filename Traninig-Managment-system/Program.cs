...
builder.Services.AddScoped<IEmployeeCertificateRepo, EmployeeCertificateRepo>();
...
builder.Services.AddScoped<ICourseChapterRepo, CourseChapterRepo>();
...
builder.Services.AddScoped<IEmployeeLessonService, EmployeeLessonService>();
builder.Services.AddScoped<IEmployeeExamService, EmployeeExamService>();
builder.Services.AddScoped<ICategoryService, CategoryService>(); 
builder.Services.AddScoped<ICategoryRepo, CategoryRepo>();
builder.Services.AddScoped<IInstructorRepo, InstructorRepo>();
builder.Services.AddScoped<IInstructorServices, InstructorServices>();
builder.Services.AddScoped<IInstructorProgressService, InstructorProgressService>();
builder.Services.AddScoped<IInstructorDashboardService, InstructorDashboardService>();
builder.Services.AddScoped<IInstructorContentService, InstructorContentService>();
