...
namespace Traninig_Managment_system.DAL.Migrations
{
    ...
    [Migration("20260506120301_AddCompanyCertificateWorkflow")]
    partial class AddCompanyCertificateWorkflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Traninig_Managment_system.DAL.Model.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Traninig_Managment_system.DAL.Model.EmployeeExamAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmployeeId", "ExamId", "SubmittedAt");

                    b.ToTable("EmployeeExamAttempts");
                });
            ...
            modelBuilder.Entity("Traninig_Managment_system.DAL.Model.Course", b =>
                {
                    b.HasOne("Traninig_Managment_system.DAL.Model.Category", "Category")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Traninig_Managment_system.DAL.Model.Employee", b =>
                {
                    ...
                    b.Navigation("EmployeeExamAttempts");
